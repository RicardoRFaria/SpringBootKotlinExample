...
class OpenWeatherService(private val openWeatherClient: OpenWeatherClient) {
    ...
    fun getTemperatureOf(city: String): Int {
        var weather : OpenWeatherTemperature
        try {
        ...
        val celsius = weather.main.temp.convertFahrenheitToCelsius()
        logger.info("Temperature found for city '$city' was '$celsius'.")
        return celsius
    }
    ...
    fun getTemperatureOf(lat: Double, lon: Double): Int {
        ...
        val celsius = weather.main.temp.convertFahrenheitToCelsius()
        logger.info("Temperature found for lat '$lat' and lon '$lon' was '$celsius'.")
        return celsius
    }
